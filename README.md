...
Measured against the **W3C XML Schema Test Suite** (5,737 schema cases from
NIST, Microsoft, IBM, Sun, Boeing and Saxonica):

| | |
|---|---|
| valid schemas accepted | **98.9%** (5,203 / 5,261) |
| invalid schemas rejected | **42.6%** (203 / 476) |
